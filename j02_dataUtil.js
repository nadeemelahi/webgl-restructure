...
"use strict";
var dataUtil = new function(){
	
	this.vertsByIndices = function( vout , vin , indices ) {
	...
	this.scale_xyz = function ( verts , sx , sy , sz ) {
	...
	this.set_z = function ( verts , z_update ) {
	...
	this.flip_winding = function ( verts ) {
	...
	this.arrayCpy_src_dst = function ( src , dst ) {
	...
	this.allocateFloats = function( data ) {
	...
	this.mk_coloursBy_repeat = function( repeat , pallete ){
		var idx , jdx , kdx 
			, cnt = pallete.length
